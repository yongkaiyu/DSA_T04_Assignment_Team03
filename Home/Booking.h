...
// Why are borrowTime and returnTime long?
...
public:
	...
	// input params: userID - ID of the user borrowing the game, gameID - ID of the game being borrowed
	...
	// input params: bookingID - ID of the booking to be returned
	...
	// post: none
	// input params: bookingID - ID of the booking
	...
	// pre : none
	// post: none
	// input params: bookingID - ID of the booking to be checked
	...
	// pre : bookingID must exist in the Booking
	// post: none
	// input params: bookingID - ID of the booking to be checked, userID - ID of the user
	...
	// input params: arr - array to hold the collected bookings, max - maximum number of bookings that can be held in arr
	...
	// input params: userID - ID of the user, arr - array to hold the collected bookings, max - maximum number of bookings that can be held in arr
	// return the number of bookings collected
